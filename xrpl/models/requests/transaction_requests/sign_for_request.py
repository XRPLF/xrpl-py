...
class SignForRequest(Request):
    ...
    def to_dict(self: SignForRequest) -> Dict[str, Any]:
        """
        Returns the dictionary representation of a SignForRequest.

        Returns:
            The dictionary representation of a SignForRequest.
        """
    ...
    def _get_errors(self: SignForRequest) -> Dict[str, str]:
        ...
        if self.secret is not None and (
            ...
            errors["SignForRequest"] = "`seed` cannot be used with `passphrase`."
