...
class TransactionType(str, Enum):
    ...
    TRUST_SET = "TrustSet"
    XCHAIN_CLAIM = "SidechainXChainClaim"
    XCHAIN_DOOR_CREATE = "SidechainCreate"
    XCHAIN_SEQ_NUM_CREATE = "SidechainXChainSeqNumCreate"
    XCHAIN_TRANSFER = "SidechainXChainTransfer"
