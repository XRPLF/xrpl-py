...
class TransactionType(str, Enum):
    ...
    CLAWBACK = "Clawback"
    CONFIDENTIAL_CLAWBACK = "ConfidentialMPTClawback"
    CONFIDENTIAL_CONVERT = "ConfidentialMPTConvert"
    CONFIDENTIAL_CONVERT_BACK = "ConfidentialMPTConvertBack"
    CONFIDENTIAL_MERGE_INBOX = "ConfidentialMPTMergeInbox"
    CONFIDENTIAL_SEND = "ConfidentialMPTSend"
