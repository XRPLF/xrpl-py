...
class TransactionType(str, Enum):
    ...
    CLAWBACK = "Clawback"
    CONFIDENTIAL_CLAWBACK = "ConfidentialClawback"
    CONFIDENTIAL_CONVERT = "ConfidentialConvert"
    CONFIDENTIAL_CONVERT_BACK = "ConfidentialConvertBack"
    CONFIDENTIAL_MERGE_INBOX = "ConfidentialMergeInbox"
    CONFIDENTIAL_SEND = "ConfidentialSend"
